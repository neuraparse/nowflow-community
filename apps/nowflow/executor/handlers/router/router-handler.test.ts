...
describe('RouterBlockHandler', () => {
  ...
  beforeEach(() => {
    ...
    // Default provider request mock returns a valid routing decision
  ...
  it('should execute router block correctly and select a path', async () => {
    ...
    // Verify the provider request payload contains the expected data
    const providerCallArgs = mockExecuteProviderRequest.mock.calls[0]
    const requestBody = providerCallArgs[1]
  ...
  it('should throw error if LLM response is not a valid target block ID', async () => {
    ...
    // Override provider mock to return an invalid block ID
  ...
  it('should handle server error responses', async () => {
    ...
    // Override provider mock to throw an error

...
export const PineconeBlock = defineBlock<PineconeResponse>({
  type: 'pinecone',
  name: 'Pinecone',
  ...
  subBlocks: [
    createOperationDropdown({
      operations: [
        { id: 'generate', label: 'Generate Embeddings' },
        { id: 'upsert_text', label: 'Upsert Text' },
        { id: 'search_text', label: 'Search With Text' },
        { id: 'search_vector', label: 'Search With Vector' },
        { id: 'fetch', label: 'Fetch Vectors' },
      ],
    }),

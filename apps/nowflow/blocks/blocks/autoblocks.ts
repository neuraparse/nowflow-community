...
export const AutoblocksBlock = defineBlock<AutoblocksResponse>({
  type: 'autoblocks',
  name: 'Autoblocks',
  ...
  tools: {
    ...
    config: {
      tool: () => 'autoblocks_prompt_manager',
      params: (params) => ({
        promptId: params.promptId,
        version: params.version === 'specific' ? params.specificVersion : params.version,
        templateParams: params.templateParams,
        apiKey: params.apiKey,
        enableABTesting: params.enableABTesting,

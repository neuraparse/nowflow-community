...
export const JiraBlock = defineBlock<JiraResponse>({
  type: 'jira',
  name: 'Jira',
  ...
  subBlocks: [
    ...
    createOperationDropdown({
      operations: [
        { id: 'read', label: 'Read Issue' },
        { id: 'read-bulk', label: 'Read Issues' },
        { id: 'update', label: 'Update Issue' },
        { id: 'write', label: 'Write Issue' },
      ],
    }),
    {
      id: 'domain',

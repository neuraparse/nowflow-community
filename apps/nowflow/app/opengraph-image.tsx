      ...
      >
        ...
        >
          <svg width="80" height="80" viewBox="0 0 64 64" fill="none">
            <defs>
              <linearGradient id="og-primary" x1="0" y1="0" x2="64" y2="64">
                <stop offset="0%" stopColor="#0f172a" />
                <stop offset="45%" stopColor="#0f766e" />
                <stop offset="100%" stopColor="#1e293b" />
              </linearGradient>
              <linearGradient id="og-accent" x1="16" y1="16" x2="48" y2="48">
                <stop offset="0%" stopColor="#5eead4" />
                <stop offset="100%" stopColor="#38bdf8" />
              </linearGradient>
            </defs>
            <rect x="4" y="4" width="56" height="56" rx="16" fill="url(#og-primary)" />
            <rect
              x="7"
              y="7"
              width="50"
            ...
            <circle cx="20" cy="20" r="1.8" fill="url(#og-accent)" opacity="0.95" />
            <circle cx="44" cy="20" r="3.5" fill="white" opacity="0.95" />
            <circle cx="44" cy="20" r="1.8" fill="url(#og-accent)" opacity="0.95" />
            <circle cx="44" cy="44" r="3.5" fill="white" opacity="0.95" />
            <circle cx="44" cy="44" r="1.8" fill="url(#og-accent)" opacity="0.95" />
            <circle cx="20" cy="44" r="3.5" fill="white" opacity="0.95" />
            <circle cx="20" cy="44" r="1.8" fill="url(#og-accent)" opacity="0.95" />
          </svg>
        </div>
      </div>

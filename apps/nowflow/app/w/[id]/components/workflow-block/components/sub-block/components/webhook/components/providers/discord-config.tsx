  ...
  return (
    <div className="space-y-4">
      ...
      <InstructionsSection title="Sending Messages to Discord (Outgoing via this URL)">
        <p>
          To send messages <i>to</i> Discord using the NowFlow Webhook URL (above), make a POST
      ...
      <Alert>
        ...
        <AlertDescription>
          The NowFlow Webhook URL allows sending messages <i>to</i> Discord. Treat it like a

...
export const WEBHOOK_PROVIDERS: { [key: string]: WebhookProvider } = {
  ...
  generic: {
    ...
    icon: (props) => (
      ...
      >
        <span className="font-medium text-white text-xs">NowFlow</span>
      </div>
    ),
    configFields: {
      token: {
  ...
  jira: {
    ...
    configFields: {
      webhookSecret: {
        ...
        placeholder: 'Enter a secret for webhook validation (optional)',
        description: 'Optional secret token to validate incoming webhook requests from Jira.',
      },
      events: {
        type: 'string',
        label: 'Event Types',
        placeholder: 'jira:issue_created, jira:issue_updated',
        description: 'Comma-separated list of Jira events to subscribe to (optional).',
      },
    },
  },
  teams: {
    ...
    configFields: {
      webhookSecret: {
        ...
        label: 'Webhook Secret',
        placeholder: 'Enter a secret for webhook validation (optional)',
        description: 'Optional secret token to validate incoming webhook requests from Teams.',
      },
      validationToken: {
        type: 'string',
        label: 'Validation Token',
        placeholder: 'Enter validation token (optional)',
        description: 'Optional validation token for Teams webhook verification.',
      },
    },
  },
}

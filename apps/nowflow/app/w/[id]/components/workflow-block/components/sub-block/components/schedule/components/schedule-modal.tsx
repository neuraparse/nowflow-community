...
export function ScheduleModal({
  ...
  return (
    <>
      <DialogContent
        className="community-ui-block-modal sm:max-w-[600px] flex flex-col p-0 gap-0 rounded-[16px]"
        hideCloseButton
      >
        ...
        <div className="community-ui-modal-scroll pt-4 px-6 pb-6 overflow-y-auto">
          {errorMessage && (
            <Alert
              variant="destructive"
              className="mb-4 rounded-lg border-red-500/[0.12] bg-red-500/[0.04] text-red-600/90 dark:text-red-400/90"
            >
              <AlertDescription className="text-[12px] font-logo">{errorMessage}</AlertDescription>
            </Alert>
          )}

          <div className="community-ui-modal-stack space-y-6">
            {/* Common date and time fields */}
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <label
                  htmlFor="scheduleStartAt"
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      id="scheduleStartAt"
                      variant="outline"
                      className="justify-start text-left font-normal w-full h-10 text-[13px] font-logo rounded-lg border-black/[0.08] dark:border-white/[0.08] bg-black/[0.02] dark:bg-white/[0.03]"
                    >
            ...
            <div className="space-y-1">
              ...
              >
                <SelectTrigger className="h-10 text-[13px] font-logo rounded-lg focus:ring-0">
            ...
            {scheduleType === 'minutes' && (
              <div className="space-y-1">
                ...
                <Input
                  ...
                  type="number"
                  min="1"
                  className="h-10 text-[13px] font-logo rounded-lg"
                />
              </div>
            )}
            ...
            {scheduleType === 'custom' && (
              <div className="space-y-1">
                ...
                <Input
                  ...
                  className="h-10 text-[13px] font-logo rounded-lg"
                />
                <p className="text-[11px] font-logo text-black/35 dark:text-white/40 mt-1">
        ...
        <DialogFooter className="px-6 py-4 w-full border-t border-black/[0.06] dark:border-white/[0.06]">
          <div className="flex w-full justify-between">
            <div>
              {scheduleId && onDelete && (
                <Button
                  ...
                  size="default"
                  className="h-8 px-4 text-[12px] font-logo font-medium rounded-lg text-red-600/70 dark:text-red-400/80 hover:bg-red-500/[0.06] border border-red-500/[0.12]"
                >
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={handleClose}
                size="default"
                className="h-8 px-4 text-[12px] font-logo font-medium rounded-lg text-black/50 dark:text-white/55 hover:text-black/70 dark:hover:text-white/75 hover:bg-black/[0.04] dark:hover:bg-white/[0.06] border border-black/[0.06] dark:border-white/[0.06]"
              >
                Cancel
              </Button>
              <Button
                ...
                className="h-8 px-5 text-[12px] font-logo font-semibold rounded-lg bg-[#4A7A68] hover:bg-[#3d6a59] dark:bg-[#94B8A6]/90 dark:hover:bg-[#94B8A6] text-white dark:text-[#1b1b1b] shadow-[0_1px_3px_rgba(74,122,104,0.3)]"
                size="default"
              >
        ...
        <AlertDialogContent className="rounded-[16px]">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className="h-8 px-5 text-[12px] font-logo font-semibold rounded-lg bg-red-600 hover:bg-red-700 text-white shadow-[0_1px_3px_rgba(220,38,38,0.3)]"
            >
              {isDeleting ? 'Deleting...' : 'Delete Schedule'}
            </AlertDialogAction>
          </AlertDialogFooter>

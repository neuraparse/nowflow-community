...
export function ControlBar({ setSearchQuery }: ControlBarProps) {
  ...
  return (
    <div className="flex h-16 w-full items-center justify-between bg-white dark:bg-slate-900 px-6 border-b border-black/[0.06] dark:border-white/[0.06] transition-all duration-200">
      {/* Left Section - Search */}

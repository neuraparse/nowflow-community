...
// Hoisted mocks for modules the real chat utils would pull in transitively.
// Without these, importing `./utils` triggers `@/db` which tries to require
...
vi.mock('@/lib/execution/env-vars', () => ({

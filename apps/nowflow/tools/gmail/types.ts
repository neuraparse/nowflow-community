...
// Trash/Untrash operation parameters
export interface GmailTrashParams extends BaseGmailParams {
  messageId: string
  untrash?: boolean
}

// Reply operation parameters
export interface GmailReplyParams extends BaseGmailParams {
  messageId: string
  body: string
  replyAll?: boolean
}
...
export interface GmailForwardParams extends BaseGmailParams {
  messageId: string
  to: string
  body?: string
}

// List labels operation parameters
export type GmailListLabelsParams = BaseGmailParams

// Modify labels operation parameters
export interface GmailModifyLabelsParams extends BaseGmailParams {
  messageId: string
  addLabelIds?: string
